      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light lg:mb-8 md:text-lg lg:text-xl text-gray-950">
              Welcome to our support desk our dedicated team is here to assist
              you every step of the way. where your product queries find swift
            ...
            <div className="ticket-section">
              ...
              <div className="card">
                <Link to={"/ticket/newticket"} className="card1" href="#">
                  <p>Create Ticket</p>
              ...
              <div className="card">
                <Link to={"/ticket/all-tickets"} className="card1" href="#">
                    <p>View All Ticket</p>
                  <div className="go-corner" href="#">
                    <div className="go-arrow">→</div>
                  </div>
          ...
          <div className="support">
            <img className="support" src={support1} alt="" />
          </div>
        </div>
      </section>
